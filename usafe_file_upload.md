...
## **Описание уязвимости**
Unsafe File Upload(Небезопасная загрузка файлов) - это уязвимость веб-преложений позволяющая злоумышленнику загружать файлы на веб-сервер и при отсутствие проверок и фильтрации загружаемой информации злоумышленник может внедрить в файл небезопасный код.
